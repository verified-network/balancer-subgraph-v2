...
export class OpenIssue extends ethereum.Event {
  get params(): OpenIssue__Params {
    return new OpenIssue__Params(this);
  }
}

export class OpenIssue__Params {
  _event: OpenIssue;

  constructor(event: OpenIssue) {
    this._event = event;
  }
...
export class PrimaryIssuePool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class PrimaryIssuePool__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class PrimaryIssuePool__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class PrimaryIssuePool__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class PrimaryIssuePool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class PrimaryIssuePool__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class PrimaryIssuePool extends ethereum.SmartContract {
  static bind(address: Address): PrimaryIssuePool {
    return new PrimaryIssuePool("PrimaryIssuePool", address);
  }
  ...
  getPausedState(): PrimaryIssuePool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new PrimaryIssuePool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getPausedState(): ethereum.CallResult<
    PrimaryIssuePool__getPausedStateResult
  > {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
    ...
    return ethereum.CallResult.fromValue(
      new PrimaryIssuePool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  onExitPool(
    ...
    userData: Bytes
  ): PrimaryIssuePool__onExitPoolResult {
    let result = super.call(
      "onExitPool",
    ...
    return new PrimaryIssuePool__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<PrimaryIssuePool__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PrimaryIssuePool__onExitPoolResult(
  ...
  onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): PrimaryIssuePool__onJoinPoolResult {
    let result = super.call(
      "onJoinPool",
    ...
    return new PrimaryIssuePool__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<PrimaryIssuePool__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PrimaryIssuePool__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray()
      )
    );
  ...
  onSwap(
    request: PrimaryIssuePool__onSwapInputRequestStruct,
    balances: Array<BigInt>,
    indexIn: BigInt,
    indexOut: BigInt
  ): BigInt {
  ...
  queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): PrimaryIssuePool__queryExitResult {
    let result = super.call(
      "queryExit",
    ...
    return new PrimaryIssuePool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<PrimaryIssuePool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PrimaryIssuePool__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray()
      )
    );
  ...
  queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): PrimaryIssuePool__queryJoinResult {
    let result = super.call(
      "queryJoin",
    ...
    return new PrimaryIssuePool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<PrimaryIssuePool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PrimaryIssuePool__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray()
      )
    );
