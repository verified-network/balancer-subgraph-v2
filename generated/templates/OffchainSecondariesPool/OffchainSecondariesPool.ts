...
export class OrderBook extends ethereum.Event {
  get params(): OrderBook__Params {
    return new OrderBook__Params(this);
  }
}

export class OrderBook__Params {
  _event: OrderBook;

  constructor(event: OrderBook) {
    this._event = event;
  }
...
export class OffchainSecondariesPool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class OffchainSecondariesPool__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class OffchainSecondariesPool__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class OffchainSecondariesPool__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class OffchainSecondariesPool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class OffchainSecondariesPool__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class OffchainSecondariesPool extends ethereum.SmartContract {
  static bind(address: Address): OffchainSecondariesPool {
    return new OffchainSecondariesPool("OffchainSecondariesPool", address);
  }
  ...
  getPausedState(): OffchainSecondariesPool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new OffchainSecondariesPool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getPausedState(): ethereum.CallResult<
    OffchainSecondariesPool__getPausedStateResult
  > {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
    ...
    return ethereum.CallResult.fromValue(
      new OffchainSecondariesPool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  onExitPool(
    ...
    userData: Bytes
  ): OffchainSecondariesPool__onExitPoolResult {
    let result = super.call(
      "onExitPool",
    ...
    return new OffchainSecondariesPool__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<OffchainSecondariesPool__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OffchainSecondariesPool__onExitPoolResult(
  ...
  onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): OffchainSecondariesPool__onJoinPoolResult {
    let result = super.call(
      "onJoinPool",
    ...
    return new OffchainSecondariesPool__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<OffchainSecondariesPool__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OffchainSecondariesPool__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray()
      )
    );
  ...
  onSwap(
    request: OffchainSecondariesPool__onSwapInputRequestStruct,
    balances: Array<BigInt>,
    indexIn: BigInt,
    indexOut: BigInt
  ): BigInt {
  ...
  queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): OffchainSecondariesPool__queryExitResult {
    let result = super.call(
      "queryExit",
    ...
    return new OffchainSecondariesPool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<OffchainSecondariesPool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OffchainSecondariesPool__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray()
      )
    );
  ...
  queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): OffchainSecondariesPool__queryJoinResult {
    let result = super.call(
      "queryJoin",
    ...
    return new OffchainSecondariesPool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<OffchainSecondariesPool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OffchainSecondariesPool__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray()
      )
    );
