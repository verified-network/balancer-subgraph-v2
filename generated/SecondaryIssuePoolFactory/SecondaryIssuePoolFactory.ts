...
export class SecondaryIssuePoolFactory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class SecondaryIssuePoolFactory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class SecondaryIssuePoolFactory extends ethereum.SmartContract {
  static bind(address: Address): SecondaryIssuePoolFactory {
    return new SecondaryIssuePoolFactory("SecondaryIssuePoolFactory", address);
  }
  ...
  create(
    ...
    let result = super.call(
      ...
      [
        ...
        ethereum.Value.fromUnsignedBigInt(minOrderSize),
  ...
  getCreationCodeContracts(): SecondaryIssuePoolFactory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new SecondaryIssuePoolFactory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }
  ...
  try_getCreationCodeContracts(): ethereum.CallResult<
    SecondaryIssuePoolFactory__getCreationCodeContractsResult
  > {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
    ...
    return ethereum.CallResult.fromValue(
      new SecondaryIssuePoolFactory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress()
      )
    );
  ...
  getPauseConfiguration(): SecondaryIssuePoolFactory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new SecondaryIssuePoolFactory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getPauseConfiguration(): ethereum.CallResult<
    SecondaryIssuePoolFactory__getPauseConfigurationResult
  > {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SecondaryIssuePoolFactory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
