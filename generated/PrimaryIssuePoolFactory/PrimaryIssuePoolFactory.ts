...
export class PrimaryIssuePoolFactory__createInputFactoryPoolParamsStruct extends ethereum.Tuple {
  get name(): string {
...
export class PrimaryIssuePoolFactory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class PrimaryIssuePoolFactory extends ethereum.SmartContract {
  static bind(address: Address): PrimaryIssuePoolFactory {
    return new PrimaryIssuePoolFactory("PrimaryIssuePoolFactory", address);
  }

  create(
    factoryPoolParams: PrimaryIssuePoolFactory__createInputFactoryPoolParamsStruct
  ): Address {
  ...
  getCreationCodeContracts(): PrimaryIssuePoolFactory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new PrimaryIssuePoolFactory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }
  ...
  try_getCreationCodeContracts(): ethereum.CallResult<
    PrimaryIssuePoolFactory__getCreationCodeContractsResult
  > {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
    ...
    return ethereum.CallResult.fromValue(
      new PrimaryIssuePoolFactory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress()
      )
    );
  ...
  getPauseConfiguration(): PrimaryIssuePoolFactory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new PrimaryIssuePoolFactory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getPauseConfiguration(): ethereum.CallResult<
    PrimaryIssuePoolFactory__getPauseConfigurationResult
  > {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PrimaryIssuePoolFactory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
