...
export class Pool extends Entity {
  constructor(id: string) {
    ...
    this.set("swapEnabledInternal", Value.fromBoolean(false));
    this.set("swapEnabledCurationSignal", Value.fromBoolean(false));
    ...
    this.set("joinExitEnabled", Value.fromBoolean(false));
    this.set("mustAllowlistLPs", Value.fromBoolean(false));
  ...
  get joinsExits(): Array<string> | null {
    let value = this.get("joinsExits");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toStringArray();
  ...
  set joinsExits(value: Array<string> | null) {
    if (!value) {
      this.unset("joinsExits");
    } else {
      this.set("joinsExits", Value.fromStringArray(<Array<string>>value));
    }
  }
  ...
  get ampUpdates(): Array<string> | null {
    let value = this.get("ampUpdates");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toStringArray();
  ...
  set ampUpdates(value: Array<string> | null) {
    if (!value) {
      this.unset("ampUpdates");
    } else {
      this.set("ampUpdates", Value.fromStringArray(<Array<string>>value));
    }
  }
  ...
  get circuitBreakers(): Array<string> | null {
    let value = this.get("circuitBreakers");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toStringArray();
  ...
  set circuitBreakers(value: Array<string> | null) {
    if (!value) {
      this.unset("circuitBreakers");
    } else {
      this.set("circuitBreakers", Value.fromStringArray(<Array<string>>value));
    }
  }
  ...
  get marginOrders(): Array<string> | null {
    let value = this.get("marginOrders");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toStringArray();
  ...
  set marginOrders(value: Array<string> | null) {
    if (!value) {
      this.unset("marginOrders");
    } else {
      this.set("marginOrders", Value.fromStringArray(<Array<string>>value));
    }
  }
}
...
export class CircuitBreaker extends Entity {
  constructor(id: string) {
    ...
    this.set("pool", Value.fromString(""));
    this.set("token", Value.fromString(""));
    this.set("bptPrice", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("lowerBoundPercentage", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("upperBoundPercentage", Value.fromBigDecimal(BigDecimal.zero()));
  }
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save CircuitBreaker entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
...
export class Token extends Entity {
  constructor(id: string) {
    ...
    this.set("totalSwapCount", Value.fromBigInt(BigInt.zero()));
    this.set("fxOracleDecimals", Value.fromI32(0));
  }
...
export class ProtocolIdData extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save ProtocolIdData entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
...
export class FXOracle extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save FXOracle entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
